    ...
    for (unsigned int i = 0; i < grid.size(); i++) {
        for (unsigned int j = 0; j < grid[i].size(); j++) {
            for (unsigned int w = 0; w < grid[i][j].pixels.size(); w++) {
                ImgOut[grid[i][j].pixels[w].x * nH * 3 + grid[i][j].pixels[w].y * 3] = grid[i][j].l;
                ImgOut[grid[i][j].pixels[w].x * nH * 3 + grid[i][j].pixels[w].y * 3 + 1] = grid[i][j].a;
                ImgOut[grid[i][j].pixels[w].x * nH * 3 + grid[i][j].pixels[w].y * 3 + 2] = grid[i][j].b;
